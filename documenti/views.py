...
class DichiarazioneCreateView(LoginRequiredMixin, CreateView):
    model = DichiarazioneIntento
    fields = ['numero_interno', 'numero_dichiarazione', 'data_dichiarazione',
              'plafond', 'anno_riferimento', 'fornitore']
...
class DichiarazioneUpdateView(LoginRequiredMixin, UpdateView):
    model = DichiarazioneIntento
    fields = ['numero_interno', 'numero_dichiarazione', 'data_dichiarazione',
              'plafond', 'anno_riferimento', 'fornitore']
    template_name = "documenti/dichiarazione_form.html"
...
class ReportPlafondView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        anni_disponibili = DichiarazioneIntento.objects.values_list("anno_riferimento", flat=True).distinct().order_by("-anno_riferimento")
        report_data = []
